...
def main(argv):
    ...
    p.add_option('-A', '--action', action='store', type='choice', dest='action', default='connect', help='The action you want to take',
                 choices=['connect', 'connections', 'replication_lag', 'replication_lag_percent', 'replset_state', 'memory', 'memory_mapped', 'lock',
                          ...
                          'asserts', 'queries_per_second', 'page_faults', 'chunks_balance', 'connect_primary', 'collection_state', 'row_count', 'replset_quorum', 'current_ops'])
...
def index_miss_ratio(con, warning, critical, perf_data):
    ...
    try:
        ...
        try:
            ...
            if data.has_key('indexCounters') and data['indexCounters'].has_key('note'):
